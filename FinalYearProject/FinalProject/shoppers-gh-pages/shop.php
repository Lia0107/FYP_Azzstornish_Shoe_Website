...
foreach ($cartItems as $item) {
  ...
  if(isset($_POST["go"]))
  {
    $_SESSION["pID"]=!empty($_POST["pID"])?$_POST["pID"]:"";
    $_SESSION["series"]=!empty($_POST["series"])?$_POST["series"]:"";
    $_SESSION["color"]=!empty($_POST["color"])?$_POST["color"]:"";
    $_SESSION["size"]=!empty($_POST["size"])?$_POST["size"]:"";
    $_SESSION["category"]=!empty($_POST["category"])?$_POST["category"]:"";
    $_SESSION["pName"]=!empty($_POST["pName"])?$_POST["pName"]:"";
          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black h5" style="margin-bottom: -40px">Shop All</h2></div>
                ...
                <form method="POST" action="shop.php">
                    <div class="block-4 text-center border">
                        ...
                        <div class="block-4-text p-4">
                            <h3>  <button name="go" style="border: none; background: none; cursor: pointer; color:black;"><?php echo $product["pName"]?></button></h3>
                            <p class="mb-0"><?php echo $product["series"]?></p><br>
                            <b><p  style="color:grey">UK <?php echo $product["size"]?></p></b>
                            <b><p  style="color:grey"><?php echo $product["category"]?></p></b>

                            <p class="text-primary font-weight-bold" style="font-size:30px;">$<?php echo $product["price"]?></p>
